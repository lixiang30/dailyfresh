...
SECRET_KEY = '4rxkcc#0zyvq1lpt#4%c4)+2b^y%pmtx#04_1smek)sxmv+6^r'
...
CACHES = {
    "default":{
        ...
        "LOCATION":"redis://:plmokn10241118@127.0.0.1:6379/9",
        "OPTIONS":{
...
#配置登录URL地址
LOGIN_URL='/user/login' # 默认/accounts/login,login后面不能多/